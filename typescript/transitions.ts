...
function show() {
  ...
  editableElements.forEach((element: HTMLElement) => element.style.color = "hsl(185, 72%, 35%)");
...
function hide() {
  ...
  editableElements.forEach((element: HTMLElement) => element.style.color = "rgb(45, 50, 72)");
